<?php $user_details = $this->WebModel->list_common_where3('user','user_id',$this->session->userdata('usersession_id')); ?>
                ...
                <ul class="dropdown-menu">
                  <li class="user-footer">
                    <div class="pull-center">
                      <a href="<?=base_url()?>userpanel/Index/LogOut" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
