...
<?php include("includes/sidemenu.php");?>
 <section class="content">
   		<legend><center><h2><b>Hot Lead list</b></h2></center></legend>
      <div class="row">
        <div class="col-xs-12">
                  ...
                  $i=0; foreach ($hotlist as $res) { 
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-primary" href="<?=base_url()?>Lead/activate/<?=$result[0]['lead_id'];?>" onclick="return confirm('Are you sure to Remove Hotlead!');">Remove Hotlead</a>  
                        <?php } ?>
                      </td>
                 <!--     <td>
