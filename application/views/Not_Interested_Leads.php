...
<?php include("includes/sidemenu.php");?>
 <section class="content">
   <legend><center><h2><b>Not Interested list</b></h2></center></legend>
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-body">
              ...
              <table data-page-length='25' id="example1" class="table table-bordered table-responsive table-hover" data-page-length='25'>
                ...
                <tbody id="changedata">
                  ...
                  $i=0; foreach ($Not_Interested_Leads as $res) { 
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                          ...
                          <a class="btn btn-primary" href="<?=base_url()?>Lead/activate/<?=$result[0]['lead_id'];?>" onclick="return confirm('Are you sure to Show!');">Remove Interested</a>  
                          <?php } ?>
                      </td>
                     <!-- <td>
